...
describe('Game', () => {
    ...
    beforeEach(() => {
        ...
        game = new game_1.Game(player, 5, 3);
        mockElement = {
            innerHTML: '',
        ...
        mockScoreboard = jest.mocked(new scoreboard_1.Scoreboard());
        game._scoreboard = mockScoreboard;
    });
    describe('constructor', () => {
        ...
        it('should create a scoreboard instance', () => {
            expect(scoreboard_1.Scoreboard).toHaveBeenCalled();
        });
    });
    describe('displayGame', () => {
        ...
        it('should handle different problem counts', () => {
            const gameWith2Problems = new game_1.Game(player, 2, 7);
        ...
        it('should handle different factors', () => {
            const gameWithFactor9 = new game_1.Game(player, 3, 9);
